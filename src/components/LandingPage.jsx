...
import './LandingPage.css'; // 🟢 Ensures your colorful styles work again
      ...
      <div className="main-container">
        ...
        <aside className="left-sidebar">
          ...
          <div className="install-box-styled">
            ...
            {/* 🟢 SMART BUTTON */}
            <button className="primary-install-btn" onClick={handleMainButtonClick}>
